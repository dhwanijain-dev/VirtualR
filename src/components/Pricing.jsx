        ...
        {pricingOptions.map((item,index)=>{
          return (
            ...
            <div className='p-10 border border-neutral-700 rounded-xl'>
              ...
              <a className='flex items-center justify-center text-center w-full h-12 p-5 mt-20 tracking-tight text-xl hover:bg-blue-900 border border-blue-900 rounded-lg transition duration-200'>Subscribe</a>
            </div>
